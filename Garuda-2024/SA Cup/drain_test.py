    ...
    while ret:
        ...
        for result in results:
            ...
            for box in boxes:
                ...
                for i in range(5):
                    if (key_coords[i]):
                        if key_coords[i][0] > x2 + 10 or key_coords[i][0] < x1 - 10 or key_coords[i][1] > y2 + 10 or \
                                key_coords[i][1] < y1 - 10:
                            key_coords[i] = None
            ...
            for box in boxes:
                ...
                if confidence > 48:
                    ...
                    cv2.putText(frame, (classnames[Class] + ":" + confidence + "%"), (x1, y1 - 30),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 2)
                    cv2.putText(frame, fps, (7, 40), cv2.FONT_HERSHEY_SIMPLEX, 1, (100, 255, 0), 3, cv2.LINE_AA)
                count+=1
                file_name = f"{path}{count}_{time_str}.jpg"  # Example: /path/to/your/directory/1_20240420_154512.jpg
